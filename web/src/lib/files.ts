import type { FileEntry, Filter } from "./types";
...
export function isShown(file: FileEntry, filter: Filter): boolean {
...
export function hiddenFileNames(files: FileEntry[], filter: Filter): string {
  return files
